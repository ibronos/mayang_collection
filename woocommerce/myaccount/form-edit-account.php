...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	<div class="row">
		<div class="col-md-8">
			...
			<p class="d-flex justify-content-between form-inline woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
			...
			<p class="d-flex justify-content-between form-inline woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
			...
			<p class="d-flex justify-content-between form-inline woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			...
			<fieldset>
				...
				<p class="d-flex justify-content-between woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
